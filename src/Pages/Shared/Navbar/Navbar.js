...
const Navbar = () => {
    ...
    return (
        <header className='left-0 top-0 sticky bg-green-100 z-40'>
                ...
                <div className='mx-3'>
                    <div className='flex flex-col md:flex-row justify-between items-center'>
                        ...
                        <div className='flex flex-wrap'>
                            ...
                            <p className='text-lg font-serif font-medium ml-2 my-3'><Link className='p-2  rounded-sm bg-green-100 hover:bg-green-300' to='/completedtask'>Completed Task</Link></p>
                        </div>
                        {/* Logout Button */}
                        {
                            user?.uid ?
